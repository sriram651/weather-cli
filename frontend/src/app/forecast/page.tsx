...
export default function Page() {
    ...
    async function fetchWeatherFor(qcity?: string) {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:8080/weather/forecast?city=${encoded}`)
            if (res.status === 404) {
            ...
            const json = raw as DailyForecastResp
            setData(json)
    ...
    return (
        <main className="min-h-screen flex items-start justify-center p-8 bg-slate-50 dark:bg-slate-900">
            <div className="w-full max-w-5xl">
                <h1 className="text-2xl font-semibold mb-4">Weather Digest — v1.0</h1>
